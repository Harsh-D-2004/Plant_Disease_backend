...
Revision ID: ac73e3d74fc2
Revises: f61f25ccd933
Create Date: 2025-01-29 09:55:49.820829
...
revision: str = 'ac73e3d74fc2'
down_revision: Union[str, None] = 'f61f25ccd933'
...
def downgrade() -> None:
    ...
    sa.Column('infected_plant', sa.VARCHAR(), autoincrement=False, nullable=False),
