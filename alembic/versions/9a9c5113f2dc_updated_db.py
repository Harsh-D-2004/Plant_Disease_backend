...
Revision ID: 9a9c5113f2dc
Revises: f70c53bbfb27
Create Date: 2025-01-31 16:25:35.414469
...
revision: str = '9a9c5113f2dc'
down_revision: Union[str, None] = 'f70c53bbfb27'
...
def downgrade() -> None:
    ...
    sa.Column('Preventive_measures', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('treatment', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('treatment_description', sa.VARCHAR(), autoincrement=False, nullable=True),
